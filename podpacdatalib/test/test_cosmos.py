...
import podpacdatalib.cosmos_stations
...
class TestCOSMOS(object):
    def test_common_coordinates(self):
        ...
        cosmos = podpacdatalib.cosmos_stations.COSMOSStations()
        cosmos_raw = podpacdatalib.cosmos_stations.COSMOSStationsRaw()
        cosmos_filled = podpacdatalib.cosmos_stations.COSMOSStations(interpolation=point_interpolation)
