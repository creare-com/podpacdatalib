...
def semver():
    ...
    -------
    str
        Semantic version of the current PODPAC Datalib installation
    """
    return ".".join([str(v) for v in VERSION])


def version():
    """Retrieve PODPAC Datalib semantic version as string
    ...
    try:
        ...
        print("Could not determine PODPAC Datalib version from git repo.\n" + str(e))
